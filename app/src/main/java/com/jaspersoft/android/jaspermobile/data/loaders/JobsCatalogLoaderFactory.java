...
public class JobsCatalogLoaderFactory extends CatalogLoadersFactory {
    ...
    @Inject
    public JobsCatalogLoaderFactory(@ApplicationContext Context context, JasperRestClient client, JobSortRepository jobFilterRepository, JobsMapper jobsMapper) {
        mContext = context;
        mClient = client;
    ...
    public CatalogLoader createLoader() {
        return new SearchJobsLoader(mContext, mClient, mJobFilterRepository, mJobsMapper);
    }
}
